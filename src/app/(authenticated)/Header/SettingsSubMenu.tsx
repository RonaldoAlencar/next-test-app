...
export default function SettingsSubMenu({ show, setShow, userEmail, userName }: SettingsSubMenuProps) {
  ...
  return (
    ...
    >
      <div className="z-50 my-4 text-base list-none divide-y rounded-lg shadow bg-gray-700 divide-gray-600 absolute top-1 right-0 w-56">
        <div className="px-4 py-3">
          <span className="block text-sm text-gray-200">{userName}</span>
