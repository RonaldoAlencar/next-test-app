  ...
  return (
    <nav className="bg-white border-gray-200">
      ...
      <a href="https://flowbite.com/" className="flex items-center">
        ...
        <span className="self-center text-2xl font-semibold whitespace-nowrap">Mural de Mensagens</span>
      </a>
      ...
      <div className="flex items-center md:order-2">
          <button 
            type="button" 
            className="flex mr-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 group focus:outline-none" 
